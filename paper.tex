...
Per-site fine structural information is relevant to class-level
identification ($d_c=4$ sites are geometrically special); direction
dominance operates at the within-class individual level and does not
nullify the class-level claim.
...
The aggregate-vs-local dissociation therefore stands as a comparison
...
The aggregate-vs-local dissociation in Section~\ref{sec:diss} reveals a
