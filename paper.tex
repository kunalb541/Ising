...
(\AxisBSignFlips{} sign-flip on active $\varepsilon$ values; the $\varepsilon=0$ null produces a gap consistent with zero as expected); and no (predictor and handle are dissociable).
